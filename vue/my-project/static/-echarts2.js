...
define('echarts/chart/tree', ['require', './base', '../util/shape/Icon', 'zrender/lib/graphic/Image', 'zrender/lib/graphic/shape/Line', 'zrender/lib/graphic/shape/BezierCurve', '../layout/Tree', '../data/Tree', '../config', '../util/ecData', 'zrender/lib/config', 'zrender/lib/core/event', 'zrender/lib/core/util', '../chart'], function (require) {
    var ChartBase = require('./base');
    var GOLDEN_SECTION = 0.618;
    // 图形依赖
    var IconShape = require('../util/shape/Icon');
    var ImageShape = require('zrender/lib/graphic/Image');
    var LineShape = require('zrender/lib/graphic/shape/Line');
    var BezierCurveShape = require('zrender/lib/graphic/shape/BezierCurve');
    // 布局依赖
    ...
    var zrConfig = require('zrender/lib/config');
    var zrEvent = require('zrender/lib/core/event');
...
define('echarts/chart/base', ['require', 'zrender/lib/graphic/Image', '../util/shape/Icon', '../util/shape/MarkLine', '../util/shape/Symbol', 'zrender/shape/Polyline', 'zrender/shape/ShapeBundle', '../config', '../util/ecData', '../util/ecAnimation', '../util/ecEffect', '../util/accMath', '../component/base', '../layout/EdgeBundling', 'zrender/lib/core/util', 'zrender/tool/area'], function (require) {
    // 图形依赖
    var ImageShape = require('zrender/lib/graphic/Image');
    var IconShape = require('../util/shape/Icon');
...
define('echarts/util/shape/Icon', ['require', 'zrender/lib/core/util', 'zrender/shape/Star', 'zrender/shape/Heart', 'zrender/shape/Droplet', 'zrender/lib/graphic/Image', 'zrender/shape/Base'], function (require) {
    var zrUtil = require('zrender/lib/core/util');
...
define('zrender/lib/graphic/Image', ['require', './Base', '../tool/util'], function (require) {

        var Base = require('./Base');

        /**
         * @alias zrender/lib/graphic/Image
         * @constructor
        ...
        var ZImage = function(options) {
            ...
            /**
             * 图片绘制样式
             * @name module:zrender/lib/graphic/Image#style
             * @type {module:zrender/lib/graphic/Image~IImageStyle}
             */
            /**
             * 图片高亮绘制样式
             * @name module:zrender/lib/graphic/Image#highlightStyle
             * @type {module:zrender/lib/graphic/Image~IImageStyle}
             */
        };
        ...
        ZImage.prototype = {
            ...
            /**
             * 计算返回图片的包围盒矩形
             * @param {module:zrender/lib/graphic/Image~IImageStyle} style
...
define('zrender/lib/graphic/shape/BezierCurve', ['require', './Base', '../tool/util'], function (require) {
        'use strict';

        var Base = require('./Base');
        
        /**
         * @alias module:zrender/lib/graphic/shape/BezierCurve
         * @constructor
         * @extends module:zrender/shape/Base
         * @param {Object} options
         */
        var BezierCurve = function(options) {
            ...
            /**
             * 贝赛尔曲线绘制样式
             * @name module:zrender/lib/graphic/shape/BezierCurve#style
             * @type {module:zrender/lib/graphic/shape/BezierCurve~IBezierCurveStyle}
             */
            /**
             * 贝赛尔曲线高亮绘制样式
             * @name module:zrender/lib/graphic/shape/BezierCurve#highlightStyle
             * @type {module:zrender/lib/graphic/shape/BezierCurve~IBezierCurveStyle}
             */
        };
        ...
        BezierCurve.prototype = {
             ...
             * @param {module:zrender/lib/graphic/shape/BezierCurve~IBezierCurveStyle} style
             */
...
define('zrender/lib/graphic/shape/Line', ['require', './Base', './util/dashedLineTo', '../tool/util'], function (require) {
        var Base = require('./Base');
        var dashedLineTo = require('./util/dashedLineTo');
        
        /**
         * @alias module:zrender/lib/graphic/shape/Line
         * @param {Object} options
         * @constructor
         * @extends module:zrender/shape/Base
         */
        var Line = function (options) {
            ...
            /**
             * 直线绘制样式
             * @name module:zrender/lib/graphic/shape/Line#style
             * @type {module:zrender/lib/graphic/shape/Line~ILineStyle}
             */
            /**
             * 直线高亮绘制样式
             * @name module:zrender/lib/graphic/shape/Line#highlightStyle
             * @type {module:zrender/lib/graphic/shape/Line~ILineStyle}
             */
        };
        ...
        Line.prototype =  {
             ...
             * 创建线条路径
             * @param {CanvasRenderingContext2D} ctx
             * @param {module:zrender/lib/graphic/shape/Line~ILineStyle} style
             */
            buildPath : function (ctx, style) {
...
define('echarts/data/Tree', ['require', 'zrender/lib/core/util'], function (require) {
...
define('zrender/lib/config', [], function () {
    /**
     * config默认配置项
     * @exports zrender/lib/config
     * @author Kener (@Kener-林峰, kener.linfeng@gmail.com)
     */
    var config = {
        /**
         * @namespace module:zrender/lib/config.EVENT
         */
        EVENT : {
            /**
             * 窗口大小变化
...
define('zrender/lib/core/util', ['require', '../dep/excanvas'], function (require) {
        ...
        /**
         * 对一个object进行深度拷贝
         * @memberOf module:zrender/lib/core/util
...
define('zrender/lib/core/event', ['require', '../mixin/Eventful'], function (require) {
        ...
        /**
        * 提取鼠标（手指）x坐标
        * @memberOf module:zrender/lib/core/event
        * @param  {Event} e 事件.
...
define('echarts/util/shape/MarkLine', ['require', 'zrender/shape/Base', './Icon', 'zrender/lib/graphic/shape/Line', 'zrender/lib/graphic/shape/BezierCurve', 'zrender/tool/area', 'zrender/shape/util/dashedLineTo', 'zrender/lib/core/util', 'zrender/tool/curve'], function (require) {
    var Base = require('zrender/shape/Base');
    var IconShape = require('./Icon');
    var LineShape = require('zrender/lib/graphic/shape/Line');
    var lineInstance = new LineShape({});
    var CurveShape = require('zrender/lib/graphic/shape/BezierCurve');
...
define('echarts/util/shape/Symbol', ['require', 'zrender/shape/Base', 'zrender/shape/Polygon', 'zrender/lib/core/util', './normalIsCover'], function (require) {
    var Base = require('zrender/shape/Base');
...
define('echarts/util/ecAnimation', ['require', 'zrender/lib/core/util', 'zrender/tool/curve', 'zrender/shape/Polygon'], function (require) {
    var zrUtil = require('zrender/lib/core/util');
    var curveTool = require('zrender/tool/curve');
...
define('echarts/util/ecEffect', ['require', '../util/ecData', 'zrender/shape/Circle', 'zrender/lib/graphic/Image', 'zrender/tool/curve', '../util/shape/Icon', '../util/shape/Symbol', 'zrender/shape/ShapeBundle', 'zrender/shape/Polyline', 'zrender/tool/vector', 'zrender/tool/env'], function (require) {
    var ecData = require('../util/ecData');
...
define('echarts/component/base', ['require', '../config', '../util/ecData', '../util/ecQuery', '../util/number', 'zrender/lib/core/util', 'zrender/tool/env'], function (require) {
    var ecConfig = require('../config');
    var ecData = require('../util/ecData');
...
define('echarts/echarts', ['require', './config', 'zrender/lib/core/util', 'zrender/lib/core/event', 'zrender/tool/env', 'zrender', 'zrender/lib/config', './chart/island', './component/toolbox', './component', './component/title', './component/tooltip', './component/legend', './util/ecData', './chart', 'zrender/tool/color', './component/timeline', 'zrender/lib/graphic/Image', 'zrender/loadingEffect/Bar', 'zrender/loadingEffect/Bubble', 'zrender/loadingEffect/DynamicLine', 'zrender/loadingEffect/Ring', 'zrender/loadingEffect/Spin', 'zrender/loadingEffect/Whirling', './theme/macarons', './theme/infographic'], function (require) {
    var ecConfig = require('./config');
    var zrUtil = require('zrender/lib/core/util');
    var zrEvent = require('zrender/lib/core/event');
     ...
     * @type {Object}
     */
    var ZR_EVENT = require('zrender/lib/config').EVENT;
...
define('echarts/component/title', ['require', './base', 'zrender/shape/Text', 'zrender/shape/Rectangle', '../config', 'zrender/lib/core/util', 'zrender/tool/area', 'zrender/tool/color', '../component'], function (require) {
    var Base = require('./base');
...
define('echarts/component/toolbox', ['require', './base', 'zrender/lib/graphic/shape/Line', 'zrender/lib/graphic/Image', 'zrender/shape/Rectangle', '../util/shape/Icon', '../config', 'zrender/lib/core/util', 'zrender/lib/config', 'zrender/lib/core/event', './dataView', '../component'], function (require) {
    var Base = require('./base');
...
define('echarts/component/legend', ['require', './base', 'zrender/shape/Text', 'zrender/shape/Rectangle', 'zrender/shape/Sector', '../util/shape/Icon', '../util/shape/Candle', '../config', 'zrender/lib/core/util', 'zrender/tool/area', '../component'], function (require) {
    var Base = require('./base');
...
define('echarts/component/tooltip', ['require', './base', '../util/shape/Cross', 'zrender/lib/graphic/shape/Line', 'zrender/shape/Rectangle', '../config', '../util/ecData', 'zrender/lib/config', 'zrender/lib/core/event', 'zrender/tool/area', 'zrender/tool/color', 'zrender/lib/core/util', 'zrender/shape/Base', '../component'], function (require) {
    var Base = require('./base');
...
define('echarts/component/timeline', ['require', './base', 'zrender/shape/Rectangle', '../util/shape/Icon', '../util/shape/Chain', '../config', 'zrender/lib/core/util', 'zrender/tool/area', 'zrender/lib/core/event', '../component'], function (require) {
    var Base = require('./base');
...
define('echarts/chart/island', ['require', './base', 'zrender/shape/Circle', '../config', '../util/ecData', 'zrender/lib/core/util', 'zrender/lib/core/event', 'zrender/tool/color', '../util/accMath', '../chart'], function (require) {
    var ChartBase = require('./base');
...
define('echarts/util/ecQuery', ['require', 'zrender/lib/core/util'], function (require) {
    var zrUtil = require('zrender/lib/core/util');
...
define('echarts/component/dataView', ['require', './base', '../config', 'zrender/lib/core/util', '../component'], function (require) {
    var Base = require('./base');
...
define('echarts/util/shape/Cross', ['require', 'zrender/shape/Base', 'zrender/lib/graphic/shape/Line', 'zrender/lib/core/util', './normalIsCover'], function (require) {
    var Base = require('zrender/shape/Base');
    var LineShape = require('zrender/lib/graphic/shape/Line');
    var zrUtil = require('zrender/lib/core/util');
...
define('echarts/util/shape/Candle', ['require', 'zrender/shape/Base', 'zrender/lib/core/util', './normalIsCover'], function (require) {
    var Base = require('zrender/shape/Base');
    var zrUtil = require('zrender/lib/core/util');
...
define('echarts/util/shape/Chain', ['require', 'zrender/shape/Base', './Icon', 'zrender/shape/util/dashedLineTo', 'zrender/lib/core/util', 'zrender/tool/matrix'], function (require) {
    var Base = require('zrender/shape/Base');
    var IconShape = require('./Icon');
...
zrender.tool = {
    ...
    util: require('zrender/lib/core/util'),
    vector: require('zrender/tool/vector'),
    area: require('zrender/tool/area'),
    event: require('zrender/lib/core/event')
}
