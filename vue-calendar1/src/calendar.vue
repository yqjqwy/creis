...
<template>
    <!-- <div class="calendar"> -->
    <v-touch @swipeleft="next"  @swiperight="prev"   tag="div" class="calendar">
        ...
        <div class="calendar-tools">
            ...
            <div class="calendar-info" @click.stop="changeYear" id="toggler-btn">
                <!-- {{monthString}} -->
                <div class="month" id="toggler-icon">
