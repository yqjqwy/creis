<template>
  <div class="comp-full-calendar">
    <!-- header pick month -->
    <fc-header :is-show-day="isShowDay" @todayClick="todayClick" :current-date="currentDate" :title-format="titleFormat" :first-day="firstDay" :month-names="monthNames" @change="emitChangeMonth">
    ...
    <fc-body ref="fcBody" :current-date="currentDate" :events="events" :month-names="monthNames" :week-names="weekNames" :first-day="firstDay" @eventclick="emitEventClick" @dayclick="emitDayClick" @moreclick="emitMoreClick">
      <div slot="body-card">
...
export default {
  ...
  methods: {
     ...
     * * */
    todayClick() {
      console.log('今天', 1111111);
      this.$refs.fcBody.dayClick(null, null, true);
    },
    ...
    emitDayClick(theItem, indexs) {
      this.$emit('dayClick', theItem, indexs);
    },
  ...
  components: {
    'fc-body': require('./components/body').default,
